...
class Config:
    ...
    def __init__(self):
        ...
        # This can be achieved by running calculate_dataset_mean.py from dataset folder,
        # just the training dateset root should be defined
        self.img_channel_mean = [228.15194302369042, 228.67398640878037, 229.4134519259212]
...
def rpn_loss_regr(num_anchors):
    ...
    def rpn_loss_regr_fixed_num(y_true, y_pred):
        ...
        x_bool = K.cast(K.less_equal(x_abs, 1), tf.float32)
...
def class_loss_regr(num_classes):
    ...
    def class_loss_regr_fixed_num(y_true, y_pred):
        x = float(int(y_true[:, :, 4*num_classes:] - y_pred))
        x_abs = K.abs(x)
