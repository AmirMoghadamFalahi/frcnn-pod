...
from utils import rpn_to_roi, calc_iou


if __name__ == '__main__':

    train_img_path = 'training_images'
    train_xml_path = 'training_xml'
    ...
    # --------------------------------------------------------#
    st = time.time()
    train_imgs, classes_count, class_mapping = get_data(input_img_path=train_img_path, input_xml_path=train_xml_path)
    print()
